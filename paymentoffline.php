...
.ordernow a{width: 200px;margin: 20px auto 0;text-align: center;padding: 5px;font-size: 30px;display: block;background: #3163E4;color: #fff;border-radius: 3px;}
</style>
            ...
            <table class="tblone">
                        ...
                        <table class="tbltwo">
                            ...
                            <tr>
                                <td>COD</td>
                                <td>:</td>
                                <td>Fee(₱<?php echo $vat = $sum * 0.03; ?>)</td>
                            </tr>
                            <tr>
                                <td>Grand Total</td>
                                <td>:</td>
